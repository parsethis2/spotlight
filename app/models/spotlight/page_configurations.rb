module Spotlight
  ...
  # A downstream application can inject its own data like so
  # Spotlight::PageConfigurations.local_params = {
  #   'my-key': 'my_val'
  # }
  # You can also pass anything that responds to #call (eg. a lambda)
  ...
  class PageConfigurations
    ...
    def downstream_parameters
      (local_params || {}).each_with_object({}) do |(key, value), hsh|
